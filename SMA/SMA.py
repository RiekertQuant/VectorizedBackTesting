...
class SMAVectorBacktester(object):
    '''
        ...
        symbol : str
            RIC symbol
        SMA1 : int
            time window for shorter sma
        SMA2 : int
            time window for larger sma
        start: str
        ...
        set_paramaters:
            sets one or two SMA params
        run_strategy:
            runs the backtest for the SMA-based staretgy 
        plot_results:
    ...
    def set_parameters(self, SMA1=None, SMA2=None):
        '''
        Updates SMA aparams and resp time series
        '''
        if SMA1 is not None:
            self.SMA1 = SMA1
...
if __name__ == '__main__':
    ...
    smabt.set_parameters(SMA1=50, SMA2=236)
    print(smabt.run_strategy())
    smabt.plot_results()
